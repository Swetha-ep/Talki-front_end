...
const user = {
  name: 'Talki',
  email: 'talki@gmail.com',
  imageUrl:
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_c1LtpjvZZ4UWQyWL4xubD-aJ7xcCenDnew&usqp=CAU',
}
...
const NavbarA = () => {
  ...
  useEffect(() => {
    ...
    const userNavigation = [
        { name: 'Your Profile', href: '/admin/profile', active: location.pathname === '/admin/profile'},
        { name: 'Settings', href: '#' },
        { name: 'Sign out', href: '#' },
      ]

      const activeItem = userNavigation.find((item) => item.active);
